...
export const fetchUtenti = async (token: string): Promise<Utente[]> => {
...
export const createUtente = async (data: Utente, token: string): Promise<Utente> => {
  const response = await fetch(`${LOCAL_HOST}/utenti`, {
    method: 'POST',
    headers: {
      Authorization: `Bearer ${token}`,
...
export const updateUtente = async (id: string, data: Utente, token: string): Promise<Utente> => {
...
export const deleteUtente = async (id: string, token: string): Promise<void> => {
  const response = await fetch(`${LOCAL_HOST}/utenti/${id}`, {
    method: 'DELETE',
    headers: {
      Authorization: `Bearer ${token}`,
